...
// Question NO 2
var c = ('Hello Eric, ');
var f = ('would you like to learn some Python today ?');
var g = (c + f);
console.log(g);
// Question NO 3
var m = ('Eric');
...
// Question NO 4
var j = ('Albert Einstein once said, “A person who never made a mistake never tried anything new.”');
console.log(j);
// Question NO 5
var famous_person = ('Quaid-e-Azam once said, ');
var message = ('“I do not believe in taking the right decision, I take a decision and make it right.”');
var out = (famous_person + message);
console.log(out);
// Question NO 6
var o = ('Eric');
console.log("\t" + o + "\t");
...
var nm = ["Akram", "Kamran", "Basit", "Muqeet"];
for (var i_2 = 0; i_2 < 4; i_2++) {
    console.log('He is my best friend ' + nm[i_2]);
}
//Question NO 13
console.log("Method No 1 with motorbikes message");
var motors = ["Honda", "Supreme", "Suzuki", "Crown"];
...
console.log("Method No 1 with motorbikes message");
var motrs = ["Honda", "Supreme", "Suzuki", "Crown"];
